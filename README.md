...
- Stable reference tests are available as
  [release assets](https://github.com/gnosischain/consensus-specs/releases).
- Unstable reference tests are available as
  [nightly builds](https://github.com/gnosischain/consensus-specs/actions/workflows/nightly-tests.yml).
...
```
git clone git@github.com:gnosischain/consensus-specs.git
```
